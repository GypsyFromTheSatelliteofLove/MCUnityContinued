...
public class FileProxy
{
    ...
    /// <param name="readOnly">File will be read-only if true, read-write if false.</param>
    /// <returns>True if successful, otherwise false.</returns>
    public bool Load(byte[] data, string name, FileUsage usage = FileUsage.UseMemory, bool readOnly = true)
    {
        // Determine file access settings
        //FileAccess fileAccess;
        //FileShare fileShare;
    ...
    /// <param name="fileShare">Defines shared access to file.</param>
    /// <returns>True if successful, otherwise false.</returns>
    /*  private bool LoadMemory(byte[] data, FileAccess fileAccess, FileShare fileShare)
      {
          // Attempt to locate in Unity Resources folder first
          string fileName = Path.GetFileName(filePath);
    ...
    /// </summary>
    /// <param name="data">Absolute path of file to load.</param>
    /// <param name="fileAccess">Defines access to file.</param>
    /// <param name="fileShare">Defines shared access to file.</param>
    /// <returns>True if successful, otherwise false.</returns>
